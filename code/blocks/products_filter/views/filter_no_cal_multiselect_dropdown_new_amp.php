...
$tmpl -> addStylesheet('products_filter_no_cal_dropdown_new_amp','blocks/products_filter/assets/css');
...
<?php if(1 == 1){ ?>
	...
	<div class="filter-manufactory">
		<div class="title_filter"><span>Thương hiệu</span><span class="icon"></div>
