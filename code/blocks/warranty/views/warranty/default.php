<?php global $tmpl;?>
<?php   $tmpl -> addStylesheet('warranty','blocks/warranty/assets/css');?>
<?php   $tmpl -> addScript('warranty','blocks/warranty/assets/js');
$tmpl -> addScript('form');
?>
...
<div class="block_warranty">
	<div class="page_title">
		<span class="title_inner_l warr_inner warr_active" id="title_l"> <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="info-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-info-circle fa-w-16 fa-2x"><path fill="currentColor" d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z" class=""></path></svg> Tra cứu thông tin bảo hành</span><div class="br"><br></div>
		<span class="title_inner_r warr_inner" id="title_r"><svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="clock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-clock fa-w-16 fa-2x"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm216 248c0 118.7-96.1 216-216 216-118.7 0-216-96.1-216-216 0-118.7 96.1-216 216-216 118.7 0 216 96.1 216 216zm-148.9 88.3l-81.2-59c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h14c6.6 0 12 5.4 12 12v146.3l70.5 51.3c5.4 3.9 6.5 11.4 2.6 16.8l-8.2 11.3c-3.9 5.3-11.4 6.5-16.8 2.6z" class=""></path></svg> Nhập thông tin bảo hành</span>
	</div>
	<div class="form_l form_" id="form_l">
		<form action="#bao-hanh" method="get" id="form_input" onkeydown="return event.key != 'Enter';">
			<input type="text" name="phone" id="phone_number" placeholder="Nhập số điện thoại hoặc mã máy để tra cứu...">
	...
	<div class="form_r form_ hide" id="form_r">
		<form action="" name="buy_fast_form" id="buy_fast_form" method="get" onkeydown="return event.key != 'Enter';">
				<div class="cls">
					<table>
						...
						<tr>
							<td><input type="text" value="" required placeholder="Mã máy*:" id="code_buy_fast" name="code_buy_fast" class="keyword input-text" />
							</td>
						</tr>
