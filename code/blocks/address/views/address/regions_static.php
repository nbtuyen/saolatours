...
<div class='address_regions'>
	...
	<div class="region_list scroll_bar">
	<?php foreach ($province as $region) {?>
		<div class="region_name">Trụ sở <?php echo $region -> name; ?></div>
		<?php foreach ($list as $item) {?>
			<?php if($item -> province == $region -> id){ ?>
				<ul class="regions_<?php echo $region -> id;?> regionss">
					<?php 	
					...
					<a href="<?php echo $link; ?>"  title="<?php echo $item -> name; ?>" ><?php echo $item->address?></a></li>
				</ul>		
			<?php } ?>
		<?php } ?>
