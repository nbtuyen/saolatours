...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			btnLeft.src="mopSlider/left-run.png";
			btnLeftF.src="mopSlider/sliderBtnLeftW_f.png";
			btnRight.src="mopSlider/right-run.png";
			btnRightF.src="mopSlider/sliderBtnRightW_f.png";
			btnCenter.src="mopSlider/center-run.png";
			...
			sldBackLeft.src="mopSlider/left-ray.jpg";
			sldBackCenter.src="mopSlider/center-ray.jpg";
			sldBackRight.src="mopSlider/right-ray.jpg";
