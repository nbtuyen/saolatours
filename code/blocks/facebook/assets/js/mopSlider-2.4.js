...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			btnLeft.src=root+"blocks/software/assets/image/mopSlider/left-run.png";
			btnLeftF.src=root+"blocks/software/assets/image/mopSlider/sliderBtnLeftW_f.png";
			btnRight.src=root+"blocks/software/assets/image/mopSlider/right-run.png";
			btnRightF.src=root+"blocks/software/assets/image/mopSlider/sliderBtnRightW_f.png";
			btnCenter.src=root+"blocks/software/assets/image/mopSlider/center-run.png";
			btnChange.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRightW.png";
			btnChangeF.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRightW_f.png";
			backImg.src=root+"blocks/software/assets/image/mopSlider/paperBack.gif";
			sldcLeftImg.src=root+"blocks/software/assets/image/mopSlider/sliderBackLeftLeftW.png";
			sldcRightImg.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRightW.png";
			sldBackLeft.src=root+"blocks/software/assets/image/mopSlider/left-ray.jpg";
			sldBackCenter.src=root+"blocks/software/assets/image/mopSlider/center-ray.jpg";
			sldBackRight.src=root+"blocks/software/assets/image/mopSlider/right-ray.jpg";
		}else if(mopSliderType=="black"){
			btnLeft.src=root+"blocks/software/assets/image/mopSlider/left-run.png";
			btnLeftF.src=root+"blocks/software/assets/image/mopSlider/sliderBtnLeft_f.png";
			btnRight.src=root+"blocks/software/assets/image/mopSlider/right-run.png";
			btnRightF.src=root+"blocks/software/assets/image/mopSlider/sliderBtnRight_f.png";
			btnCenter.src=root+"blocks/software/assets/image/mopSlider/center-run.png";
			btnChange.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRight.png";
			btnChangeF.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRight_f.png";
			backImg.src=root+"blocks/software/assets/image/mopSlider/monoBack.gif";
			sldcLeftImg.src=root+"blocks/software/assets/image/mopSlider/sliderBackLeftLeft.png";
			sldcRightImg.src=root+"blocks/software/assets/image/mopSlider/sliderBackRightRight.png";
			sldBackLeft.src=root+"blocks/software/assets/image/mopSlider/left-ray.jpg";
			sldBackCenter.src=root+"blocks/software/assets/image/mopSlider/center-ray.jpg";
			sldBackRight.src=root+"blocks/software/assets/image/mopSlider/right-ray.jpg";
		}
...
/*			backImg.src=root+"blocks/software/assets/image/mopSlider/paperBack.gif";*/
		...
		$(mopSliderName+" .sldLeft").css({left:"0px",position:"absolute",height:"10px",width:"13px",backgroundImage:"url("+sldBackLeft.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sldCenter").css({left:"13px",width:sldW-26+px,position:"absolute",height:"10px",backgroundImage:"url("+sldBackCenter.src+")",backgroundRepeat:"repeat-x"});
		$(mopSliderName+" .sldRight").css({right:"0px",position:"absolute",height:"10px",width:"13px",backgroundImage:"url("+sldBackRight.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sliderBtn").css({position:"absolute",height:"22px",left:"0px",cursor:"pointer"});
		$(mopSliderName+" .sldBtnLeft").css({left:"0px",position:"absolute",height:"10px",width:"10px",backgroundImage:"url("+btnLeft.src+")",backgroundRepeat:"no-repeat"});
		$(mopSliderName+" .sldBtnCenter").css({left:"10px",width:btnW-19+px,position:"absolute",height:"10px",backgroundImage:"url("+btnCenter.src+")",backgroundRepeat:"repeat-x"});
		$(mopSliderName+" .sldBtnRight").css({right:"0px",position:"absolute",height:"10px",width:"10px",backgroundImage:"url("+btnRight.src+")",backgroundRepeat:"no-repeat"});
		...
		$(mopSliderName).css({position:"relative",overflow:"hidden",padding:"15px 0px 0px 0px",margin:"0 auto 0 auto",backgroundImage:"url("+backImg.src+")"});
