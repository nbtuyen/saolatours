<?php 
	class Products_listBModelsProducts_list
	{
...
//					}
			...
			$order .= ' ordering DESC,created_time DESC';
			 ...
			 $query = " SELECT id,name,is_accessories,alias,image,category_alias,price,price_old,quantity,hits,sale_count,discount,date_start,date_end,warranty,summary,types,is_new,accessories , category_id 
						 FROM fs_products
