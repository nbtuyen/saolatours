...
class Mysql_DB {
    ...
    function connect() {
    	global $db_info;
        $this->conn_id = @mysql_connect($db_info['dbHost'].":".$this->port,$db_info['dbUser'],$db_info['dbPass']);
...
//		$fn = "log_mysql/log_".time().".txt";
		...
		if(isset($_SESSION['ad_userid']))
			$content = '\n================REMOTE: '.$_SERVER['REMOTE_ADDR'].'========('.$_SESSION['ad_username'].'=>'.$_SESSION['ad_userid'] .')=================('.$time.')===================\n';
		else
