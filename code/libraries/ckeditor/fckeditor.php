...
class FCKeditor
{
	...
	public function Create()
	{
		...
		echo "<script>CKEDITOR.replace( '".$this->InstanceName."',{
			filebrowserBrowseUrl : '../libraries/ckeditor/plugins/ckfinder/ckfinder.html',
			filebrowserImageBrowseUrl : '../libraries/ckeditor/plugins/ckfinder/ckfinder.html?type=Images&currentFolder=".$currentFolder."',
			filebrowserFlashBrowseUrl : '../libraries/ckeditor/plugins/ckfinder/ckfinder.html?type=Flash',
			filebrowserUploadUrl : 
		 	   '../libraries/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&currentFolder=".$currentFolder."',
			filebrowserImageUploadUrl : 
			   '../libraries/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images&currentFolder=".$currentFolder."',
			filebrowserFlashUploadUrl : '../libraries/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
				});</script>" ;
