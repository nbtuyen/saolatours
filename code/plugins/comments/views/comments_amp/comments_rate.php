<div class="rating_area cls">
	<span id="ratings1" class="cls">
		<?php $point = !empty($data -> rating_count) ? round($data -> rating_sum /$data -> rating_count): 5 ; ?>
		<?php
		// check cookies
		$disable_rating = 0;
		...
		<input type="hidden" name='rating_disable' id='rating_disable1' value='<?php echo $disable_rating;?>'>	
