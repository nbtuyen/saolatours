...
class TemplateHelper
{
	...
	public static function reverse_status($cid,$field, $value_new,$module,$view)
	{
		...
		if($value_new != 1)
		{
			...
			<img border=\"0\" alt=\"Enabled status\" src=\"templates/default/images/published.png\"></a></div>";
		}
		else
		{
			...
			<img border=\"0\" alt=\"Disable status\" src=\"templates/default/images/unpublished.png\"></a></div>";
		}		
		return $html;
	}
	...
	public static function edit_grapesjs($link)
	{
		...
		$html .="<img  border=\"0\" alt=\"Views\" src=\"templates/default/images/display.png\" /></a>";
		return $html;
	}
	...
	public static function edit($link)
	{
		...
		$html .="<img  border=\"0\" alt=\"Views\" src=\"templates/default/images/edit.png\" /></a>";
		return $html;
	}
...
//				$compare = $value;
	 ...
	 * $sub_item: cột phụ
	 */
	static function dt_edit_selectbox($title,$name,$value,$default = '',$arry_select = array(),$field_value = 'id', $field_label='name',$size = 1,$multi  = 0,$add_fisrt_option=0,$comment = '',$sub_item = '',$class='chosen-select',$class_col1='col-md-2',$class_col2='col-md-10'){
		global $db;
		$module =$_GET['module'];
		$view= $_GET['view'];
...
//				$compare = $value;
	...
	public static function dt_edit_text($title,$name,$value,$default = '',$size = 60,$rows = 1,$editor = 0,$comment='',$sub_item = '',$class_col1='col-md-2',$class_col2='col-md-10'){
		// echo "<pre>";
