<?php if(isset($config['fields_seo_keyword']['fields']) && $config['fields_seo_keyword']['fields'] && count($config['fields_seo_keyword']['fields'])): ?>
	...
	<tr>
		...
		<td   valign="top">
			...
			$arr_fields_seo_keyword = !empty($data_fields_seo_keyword)? explode('|',$data_fields_seo_keyword ):array();	
			?>
		...
		<td  width="30">
			<?php if(isset($config['fields_seo_keyword']['help']) && $config['fields_seo_keyword']['help'] ) {?>
					<div class='help_area'>	
						...
						<div class='help' style="display: none"><?php echo $config['fields_seo_keyword']['help'] ;?></div>
					</div>
			<?php }else{?>
				&nbsp;
			<?php }?>
