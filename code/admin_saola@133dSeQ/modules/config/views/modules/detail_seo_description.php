<?php if(isset($config['fields_seo_description']['fields']) && $config['fields_seo_description']['fields'] && count($config['fields_seo_description']['fields'])): ?>
	...
	<tr>
		...
		<td   valign="top">
			...
			$arr_fields_seo_description = !empty($data_fields_seo_description)? explode('|',$data_fields_seo_description):array();	
			?>
		...
		<td  width="30">
			<?php if(isset($config['fields_seo_description']['help']) && $config['fields_seo_description']['help'] ) {?>
					<div class='help_area'>	
						...
						<div class='help' style="display: none"><?php echo $config['fields_seo_description']['help'] ;?></div>
					</div>
			<?php }else{?>
				&nbsp;
			<?php }?>
