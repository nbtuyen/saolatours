<?php 
class PartnersModelsCategories extends FSModels
{
	var $limit;
	var $prefix ;
	function __construct()
	{
		...
		$this -> table_news = FSTable_ad::_('fs_partners');
		$this -> table_name = FSTable_ad::_('fs_partners_categories');
		$this -> arr_img_paths = array(array('resized',250,250,'resize_image'),array('large',400,400,'resize_image'),array('compress',1,1,'compress'));
		$this -> img_folder = 'images/partners/cat';
		$this -> check_alias = 0;
