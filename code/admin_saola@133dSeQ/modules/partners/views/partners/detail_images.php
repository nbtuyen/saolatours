...
echo '<h5 style="color:red;">Lưu ý kích thước ảnh 550x360</h5>';
$arr_sku_map = array(); 
			$i= 0;
 ...
 $(function() {				
					$("#previews").sortable({
						update : function () {
							...
							$.ajax({
								url: "index2.php?module=partners&view=partners&raw=1&task=sort_other_images",
								type: "post",
								data: serial,
								error: function(){
...
//					  parallelUploads: 100,
//					  maxFiles: 100,
				  url: "index2.php?module=partners&view=partners&raw=1&task=upload_other_images&data="+uploadConfig,
				  thumbnailWidth: 100,
				  thumbnailHeight: 100,
				  parallelUploads: 20,
				  ...
				  removedfile: function(file) {
					    ...
					    $.ajax({
					        type: "POST",
					        url: "index2.php?module=partners&view=partners&raw=1&task=delete_other_image",
