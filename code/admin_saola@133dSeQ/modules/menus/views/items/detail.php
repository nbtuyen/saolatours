<!-- HEAD -->
    ...
    // TemplateHelper::dt_checkbox(FSText::_('Fix chiều cao'),'fix_height',@$data -> fix_height,0); 
    ...
    TemplateHelper::dt_edit_text(FSText :: _('Cột'),'column_number',@$data -> column_number);
