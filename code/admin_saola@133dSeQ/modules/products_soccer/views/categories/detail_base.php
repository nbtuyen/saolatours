<?php
	if(!empty($data)){
		$link = FSRoute::_('index.php?module=products_soccer&view=cat&ccode='.$data -> alias.'&cid='.$data->id);
...
// TemplateHelper::dt_edit_image(FSText :: _('Ảnh trang chủ'),'image',str_replace('/original/','/large/',URL_ROOT.@$data->image),100,234,'Kích cỡ ảnh: 350x820');
