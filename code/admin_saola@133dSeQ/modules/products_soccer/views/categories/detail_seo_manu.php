	...
	<table width="100%" bordercolor="#AAA" border="1">
		...
		<script type="text/javascript" >
			...
			function search_seo_manu(){
				...
				$.get("index2.php?module=products_soccer&view=categories&task=ajax_get_seo_manu&raw=1",{tablename:tablename,category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
