...
function search_videos_related(){
	$('#videos_related_search').click(function(){
		...
		$.get("index2.php?module=products_soccer&view=categories&task=ajax_get_videos_related&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
