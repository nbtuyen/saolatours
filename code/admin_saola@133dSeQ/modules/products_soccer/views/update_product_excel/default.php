...
<fieldset id="zone-upload-analytics">
	...
	<?php }else {?>
		<legend class="title">Update sản phẩm từ excel</legend>
<!--		<span style="color:red;">Cột Name trong file exel phải trùng với tên sản phẩm</span>-->
	...
	<div id="content-form-upload-import-excel">
		<form id="frm-import-excel-for-product" action="index.php?module=products_soccer&view=update_product_excel&task=import_product" method="POST" enctype="multipart/form-data">
			...
			<div class="one-row-input">
				...
				<div class="input">
					...
					<input type="button" value="Mẫu update" onclick="location.href='index.php?module=products_soccer&view=update_product_excel&task=download_file&raw=1' ">
					<input type="button" value="Hướng dẫn nhập file" onclick="location.href='index.php?module=products_soccer&view=update_product_excel&task=download_file_tutorial&raw=1' ">
				</div>
			</div>
