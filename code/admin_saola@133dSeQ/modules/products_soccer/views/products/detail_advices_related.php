...
function search_advices_related(){
	$('#advices_related_search').click(function(){
		...
		$.get("index2.php?module=products_soccer&view=products&task=ajax_get_advices_related&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
