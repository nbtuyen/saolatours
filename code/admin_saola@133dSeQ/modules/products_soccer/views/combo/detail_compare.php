...
function search_products_compare(){
	$('#products_compare_search').click(function(){
		...
		$.get("index2.php?module=products_soccer&view=products&task=ajax_get_products_compare&raw=1",{product_id:product_id,category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
