<?php  
	global $toolbar;
	$toolbar->setTitle(FSText::_('Tags nhóm sản phẩm') );
	...
	$list_config[] = array('title'=>'Người tạo','field'=>'user_name','ordering'=> 1, 'type'=>'text');
	$list_config[] = array('title'=>'Thời gian tạo','field'=>'created_time','ordering'=> 1, 'type'=>'text');
