...
function search_products_related(){
	$('#products_related_search').click(function(){
		...
		$.get("index2.php?module=products_soccer&view=products&task=ajax_get_products_related&raw=1",{product_id:product_id,category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
