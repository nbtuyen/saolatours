<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Export') );
	...
	$toolbar->addButton('export_qc',FSText :: _('Export quảng cáo'),'','Excel-icon.png');
	
	//	FILTER
	$filter_config  = array();
	$fitler_config['search'] = 1; 
	$fitler_config['filter_count'] = 6;
	...
	// $filter_hot['list'] = array(2=>'Không',1=>'Có'); 
...
//	$list_config[] = array('title'=>'Giá','field'=>'price','ordering'=> 1, 'type'=>'text','col_width' => '10%','arr_params'=>array('function'=>'format_money'));
	...
	$list_config[] = array('title'=>'Giá cũ','field'=>'price_old','no_col'=>3, 'type'=>'text','display_label'=>1,'arr_params'=>array('size'=>10));
...
<div id="export_form" class="export_form">
	...
	<input type="text" placeholder="Export tới" class="form-control" name="export_to" id="export_to" value="2000">
...
<div id="export_form_qc" class="export_form">
	<p>Nhập giới hạn export quảng cáo</p>
	<label>Export từ</label>
	<input type="text" placeholder="Export từ" class="form-control" name="export_from" id="export_from" value="0">
	<label>Export tới</label>
	<input type="text" placeholder="Export tới" class="form-control" name="export_to" id="export_to_qc" value="2000">
	<button type="button" onclick="javascript:call_export_qc()">Export</button>
	<a href="javascript:void(0)" onclick="javascript:close_export_qc()" id="close_export_qc" class="close_export">X</a>
</div>



<script type="text/javascript">
	function call_export_qc(){
		url_current = window.location.href;
		url_current = url_current.replace('#','');
		var export_from = $('#export_from_qc').val();
		var export_to = $('#export_to_qc').val();
		link = url_current+'&task=export_qc&export_from='+export_from+'&export_to='+export_to+'&raw=1';
