...
function add_product_incentives(id){
	if(id)
		window.open("index2.php?module=products_soccer&view=products_incentives&id="+id, "","height=600,width=700,menubar=0,resizable=1,scrollbars=1,statusbar=0,titlebar=0,toolbar=0");
}
function remove_incentives(id,product_incentives_id){
	$.get("index.php?module=products_soccer&view=products&task=remove_incentives&raw=1&id="+id,{product_incentives_id: product_incentives_id}, function(j){
		if(j == 0){
