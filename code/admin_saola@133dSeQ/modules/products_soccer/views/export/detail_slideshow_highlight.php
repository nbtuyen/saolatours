...
$(function() {	
					$("#previews_slideshow_highlight").sortable({
						update : function () {
							...
							$.ajax({
								url: "index2.php?module=products_soccer&view=products&raw=1&task=sort_other_slideshow_highlight",
								type: "post",
...
//					  parallelUploads: 100,
//					  maxFiles: 100,
				  url: "index2.php?module=products_soccer&view=products&raw=1&task=upload_other_slideshow_highlight&data="+uploadConfig_slideshow_highlight,
				  thumbnailWidth: 100,
				  thumbnailHeight: 100,
				  parallelUploads: 20,
				  ...
				  removedfile: function(file) {
					    ...
					    $.ajax({
					        type: "POST",
					        url: "index2.php?module=products_soccer&view=products&raw=1&task=delete_other_slideshow_highlight",
...
// 	 $.ajax({
//         type: "POST",
//         url: "index2.php?module=products_soccer&view=products&raw=1&task=change_attr_slideshow_highlight",
