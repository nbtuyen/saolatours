...
<script type="text/javascript">
	...
	function add_product(product_incentives_id){
		$.get("index.php?module=products_soccer&view=products_incentives&task=add_products&raw=1",{product_incentives_id: product_incentives_id,id:id}, function(j){
			 j = eval("(" + j + ")");
			status = j['status'];
			if(status == 0){
				...
				row_continue = window.opener.$(".record_incentives_continue");
