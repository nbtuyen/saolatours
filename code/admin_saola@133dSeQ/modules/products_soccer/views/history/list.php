<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Lịch sử sửa sản phẩm') );
...
//	$fitler_config['filter'][] = $filter_categories;																																																																																			
	...
	//	CONFIG	
	$list_config = array();
	$list_config[] = array('title'=>'Người thay đổi','field'=>'action_username','type'=>'text','col_width' => '30%');
	// $list_config[] = array('title'=>'Chức vụ','field'=>'action_name','type'=>'text','col_width' => '30%');
	$list_config[] = array('title'=>'Tiêu đề','field'=>'name','ordering'=> 1, 'type'=>'text','col_width' => '20%');
