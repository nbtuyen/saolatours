...
//			
//			// data from fs_products_soccer_categories
...
//			echo $rendered_diff;
		...
		function view_compare($data,$total_his,$i){
			if($i+ 1 < $total_his){	
				$link = 'index.php?module=products_soccer&view=history&task=compare&id[]='.$data ->id.'&record_id='.$data->record_id;
		...
		function back()
		{
			...
			$link = 'index.php?module=products_soccer&view=products';
			setRedirect($link);	
		}
	}
			function view_compare($data,$total_his,$i){
