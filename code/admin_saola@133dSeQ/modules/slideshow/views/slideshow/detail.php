...
$toolbar->addButton('back',FSText :: _('Cancel'),'','back.png');   
	...
	TemplateHelper::dt_edit_text(FSText :: _('Tên nút'),'button_name',@$data -> button_name);
//	TemplateHelper::dt_edit_text(FSText :: _('Alias'),'alias',@$data -> alias,'',60,1,0,FSText::_("Can auto generate"));
	...
	TemplateHelper::dt_edit_text(FSText :: _('Summary'),'summary',@$data -> summary,'',100,4);
	TemplateHelper::dt_checkbox(FSText::_('Hiện chữ'),'show_text',@$data -> show_text,1);
	TemplateHelper::dt_edit_text(FSText :: _('Màu chữ'),'color',@$data -> color,'',60,1,0,FSText::_("Nhập mã màu: #000"));
