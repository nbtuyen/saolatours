<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Khoảng giá nhận mã giảm giá') );
	...
	$list_config[] = array('title'=>'Số tiền từ','field'=>'min_price','ordering'=> 1, 'type'=>'text');
	$list_config[] = array('title'=>'Số tiền đến','field'=>'max_price','ordering'=> 1, 'type'=>'text');
