...
$toolbar->addButton('back',FSText :: _('Cancel'),'','back.png');   
	...
	TemplateHelper::dt_edit_text(FSText :: _('Số tiền từ'),'min_price',@$data -> min_price);
	TemplateHelper::dt_edit_text(FSText :: _('Số tiền đến'),'max_price',@$data -> max_price);
	...
	TemplateHelper::dt_edit_text(FSText :: _('Số tiền được giảm'),'money_dow',@$data -> money_dow);
	TemplateHelper::dt_edit_text(FSText :: _('Số lượng được giảm'),'number_sale',@$data -> number_sale);
	TemplateHelper::dt_edit_text(FSText :: _('Đơn hàng có giá trị trên'),'total_price',@$data -> total_price);
