...
$toolbar->addButton('back',FSText :: _('Cancel'),'','back.png');   
	...
	TemplateHelper::dt_edit_text(FSText :: _('User ID'),'user_id',@$data -> user_id);
	TemplateHelper::dt_edit_text(FSText :: _('Được sinh ra từ đơn hàng'),'code_order',@$data -> code_order);
