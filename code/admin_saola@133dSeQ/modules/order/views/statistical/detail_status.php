...
<div class="step-order">
	...
	<div class="item <?php echo $order->status >= 2 && $order->status !=6 ? 'actived-stt' : '' ?>">
		<span class="number-step"><span class="nb">3</span><span class="txt-step">Đã chuyển qua kho</span></span>
		<div class="line"></div>
	</div>
	<div class="item <?php echo $order->status >= 3 && $order->status !=6 ? 'actived-stt' : '' ?>">
		<span class="number-step"><span class="nb">4</span><span class="txt-step">Đã đóng gói</span></span>
		<div class="line"></div>
	</div>
	<div class="item <?php echo $order->status >= 4 && $order->status !=6 ? 'actived-stt' : '' ?>">
		<span class="number-step"><span class="nb">5</span><span class="txt-step">Đang tiến hành giao</span></span>
		<div class="line"></div>
	</div>
	<div class="item <?php echo $order->status == 5 && $order->status !=6 ? 'actived-stt' : '' ?>">
		<span class="number-step"><span class="nb">6</span><span class="txt-step">Hoàn tất</span></span>
	</div>
</div>
