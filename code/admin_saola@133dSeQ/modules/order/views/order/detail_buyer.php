...
<div class="form_user_footer_body">
	...
	<table cellspacing="0" cellpadding="6" border="0" width="100%" class="tabl-info-customer">
		<tbody> 
			...
			<?php } ?>
			<?php if($order-> sender_address_googlemap){ ?>
			<tr>
				<td><b>Địa chỉ khách nhập để xác định km ship </b></td>
				<td width="5px">:</td>
				<td><?php echo $order-> sender_address_googlemap; ?></td>
			</tr>
			<?php } ?>
			<?php if($order-> km_ship){ ?>
			<tr>
				<td><b>Số km tính ship </b></td>
				<td width="5px">:</td>
				<td><?php echo $order-> km_ship; ?> km</td>
			</tr>
			<?php } ?>
...
<div class="form_user_footer_body">
	...
	<table cellspacing="0" cellpadding="6" border="0" width="100%" class="tabl-info-customer">
		<tbody> 
			...
			<tr>
				<td width="173px"><b>Email</b></td>
				<td width="5px">:</td>
				<td><?php echo $order-> tax_email; ?></td>
			</tr>
			<tr>
