		...
		<tr valign="top">
			<td width="0%" id='products_add_l' style="display:none" >
				<div class='products_add_search'>
					...
					<select style="display: none" name="products_add_category_id"  id="products_add_category_id">
					...
					<ul id='products_add_sortable'>	
						...
						?>
							<li id='add_products_item_selected_<?php echo $item ->id?>'>
								...
								<a class='news_remove_relate_bt'  onclick="javascript: remove_products_add(<?php echo $item->id?>)" href="javascript: void(0)" title='Xóa'><img border="0" alt="Remove" src="templates/default/images/toolbar/remove_2.png"></a> 
...
function search_products_add(){
	$('#products_add_search').click(function(){
		...
		$.get("index2.php?module=sales&view=sales&task=ajax_get_products_combopricedown&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
