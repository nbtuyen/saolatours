...
<?php 
	TemplateHelper::dt_text(FSText :: _('Loại'),'Chiết khấu theo tổng giá trị đơn hàng');
	TemplateHelper::dt_edit_text(FSText :: _('Name'),'name',@$data -> name);
	TemplateHelper::dt_edit_text(FSText :: _('Alias'),'alias',@$data -> alias,'',60,1,0,FSText::_("Can auto generate"));
	TemplateHelper::dt_edit_text(FSText :: _('Tên ngắn'),'sort',@$data -> sort,'Quà tặng giá trị');
	
	TemplateHelper::dt_edit_text(FSText :: _('Giá trị thấp nhất'),'price_min',@$data -> price_min);
...
//	TemplateHelper::dt_checkbox(FSText::_('Thẻ member có được giảm giá tiếp?'),'is_down_member',@$data -> is_down_member,0);
	...
	TemplateHelper::dt_edit_text(FSText :: _('Giảm giá'),'member_level_1',@$data -> member_level_1,'',10,1,0,FSText::_("%"));
