...
function search_gifts_add(){
	$('#gifts_add_search').click(function(){
		...
		$.get("index2.php?module=sales&view=sales&task=ajax_get_gifts_salenselectgift&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
