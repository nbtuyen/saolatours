...
function search_products_add(){
	$('#products_add_search').click(function(){
		...
		$.get("index2.php?module=sales&view=sales&task=ajax_get_products_salenselectgift&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
