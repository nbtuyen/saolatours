<?php  
	...
	//Loại sản phẩm
	$filter_category_products = array();
	$filter_category_products['title'] = FSText::_('Danh mục đăng kí'); 
	$filter_category_products['list'] = @$category_products;
	$fitler_config['filter'][] = $filter_category_products;
	...
	$list_config[] = array('title'=>'Số điện thoại','field'=>'telephone','type'=>'text','arr_params');
	// $list_config[] = array('title'=>'Điểm','field'=>'point','ordering'=> 1, 'type'=>'text');
	// $list_config[] = array('title'=>'Hạng thành viên','field'=>'level_name','ordering'=> 1, 'type'=>'text','col_width' => '20%');
