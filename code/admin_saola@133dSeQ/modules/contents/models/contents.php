<?php 
	class ContentsModelsContents extends FSModels
	{
		...
		function __construct()
		{
			...
			$this -> table_category_name = 'fs_contents_categories';
			$this -> table_types = 'fs_contents_types';
			$this -> arr_img_paths = array(array('resized',364,143,'resized_not_crop'),array('small',80,60,'resized_not_crop'),array('large',250,180,'resize_image'));
			$this -> table_name = 'fs_contents';
