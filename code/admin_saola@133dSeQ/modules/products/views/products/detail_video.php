...
$i=0; ?>
	<table border="1" class="tbl_form_contents" width="100%" cellspacing="4" cellpadding="4" bordercolor="#CCC">
		<thead>
			<tr>
				<th align="center" >
					<?php echo FSText :: _('Link video youtube'); ?>
				</th>
				<th align="center" >
					<?php echo FSText :: _('Title'); ?>
				</th>
				<th align="center"  width="50%">
					<?php echo FSText :: _('Image'); ?> ( Kích thước 980x510 px )
				</th>
		...
		?>
			<tr>
                <td>
                    ...
                    <input type="text" size="60" value="<?php echo $item -> link; ?>" name="days_link_exist_<?php echo $i;?>"/>
				</td>
				<td>
		...
		<?php for($i = 1; $i < 20; $i ++ ) { ?>
			<tr id='new_videoss_<?php echo $i?>' class='new_record closed'>
                <td>
					<input type="text" size="60" id="new_days_link_<?php echo $i;?>" name="new_days_link_<?php echo $i;?>"/>
				</td>
