	<table border="1" class="tbl_form_contents" width="100%" cellspacing="4" cellpadding="4" bordercolor="#CCC">
		<thead>
			<tr>
				...
				<th align="center" >
					<?php echo FSText::_('Giá (Nhập phần chênh với giá gốc)');?>	
				</th>
			...
			<?php if(@$data_by_color){?>
				<tr>
					...
					<td>
						...
						<?php if(1==2){ ?>
						Giá cũ:
						<input type="text" size="20" id="color_price_old_exit_<?php echo $item->id;?>" onkeypress="nurZahlen(this)" name="color_price_old_exist_<?php echo $item->id;?>"  value="<?php echo @$data_by_color->price_old;?>">
						<?php } ?>
					</td>
					<td>
			...
			<?php }else{?>
				<tr>
					...
					<td>
						...
						<?php if(1==2){ ?>
						Giá cũ:
						<input type="text" size="20" id="new_color_price_old_<?php echo $item->id;?>" onkeypress="nurZahlen(this)" name="new_color_price_old_<?php echo $item->id;?>" >
						<?php } ?>
					</td>
					<td>
