...
function search_products_related(){
	$('#products_related_search').click(function(){
		...
		$.get("index2.php?module=products&view=gift&task=ajax_get_products_related&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
