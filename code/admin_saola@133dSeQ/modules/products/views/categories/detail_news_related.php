...
function search_news_related(){
	$('#news_related_search').click(function(){
		...
		$.get("index2.php?module=products&view=categories&task=ajax_get_news_related&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
