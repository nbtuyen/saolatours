...
function search_products_gift(){
	$('#products_gift_search').click(function(){
		...
		$.get("index2.php?module=products&view=setup_aq&task=ajax_get_products_gift&raw=1",{category_id:category_id,keyword:keyword,str_exist:str_exist}, function(html){
