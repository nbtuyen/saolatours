<?php  
	global $toolbar;
	$toolbar->setTitle(FSText :: _('Dòng xe') );
			...
			<table border="1" class="tbl_form_contents" cellpadding="5" bordercolor="#CCC">
				<thead>
					...
					<th class="title" width="17%">
						<?php echo  TemplateHelper::orderTable('Hãng sản xuất', 'b.name',@$sort_field,@$sort_direct) ; ?>
					</th>
...
<!--								<td> <?php echo date('d/m/Y H:i',strtotime($row->created_time))?></td>-->
		...
		<input type="hidden" value="<?php echo 'name,ordering';?>" name="field_change">
