<?php  
	global $toolbar;
	$toolbar->setTitle(FSText::_('Phường Xã') );
	...
	$filter_districts['title'] = FSText::_('Quận huyện'); 
	$filter_districts['list'] = @$districts;
	 
	//SP tiêu biểu
	$filter_lat_log = array();
	$filter_lat_log['title'] = FSText::_('Chưa nhập vị trí'); 
	$filter_lat_log['list'] = array(1=>'Chưa nhập');

	$fitler_config['filter'][] = $filter_cities;
	$fitler_config['filter'][] = $filter_districts;
	$fitler_config['filter'][] = $filter_lat_log;
	...
	$list_config[] = array('title'=>'Quận huyện','field'=>'district_id','ordering'=> 1, 'type'=>'edit_selectbox','arr_params'=>array('arry_select'=>$districts,'field_value'=>'id','field_label'=>'name','size'=>10));
