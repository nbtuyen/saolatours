<?php  
	...
	$list_config[] = array('title'=>'Name','field'=>'treename','ordering'=> 1, 'type'=>'text','col_width' => '10%','align'=>'left','arr_params'=>array('have_link_edit'=> 1));
	...
	$list_config[] = array('title'=>'Hiện SP đặc biệt danh mục','field'=>'show_product_special_cat','ordering'=> 1, 'type'=>'change_status');
	$list_config[] = array('title'=>'Edit','type'=>'edit');
	$list_config[] = array('title'=>'Id','field'=>'id','ordering'=> 1, 'type'=>'text');

	$list_config[] = array('title'=>'Bảng','field'=>'tablenames','ordering'=> 1, 'type'=>'text','col_width' => '20%','align'=>'left');
