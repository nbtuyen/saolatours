		...
		function upload_excel($input_name)
		{
			...
			if(	!$excel){
				...
				if($cid){
					...
					if($rs)
					{
						setRedirect("index.php?module=products&view=add_update_excel&cid=$cid",FSText::_('Có').'<strong> '.$rs.'</strong> '.'bản ghi được cập nhật','suc');
					}
					else 
					{
						setRedirect("index.php?module=products&view=add_update_excel&cid=$cid",FSText::_('Không có bản ghi nào được cập nhật'),'alert');
					}	
				}else{
                                        // echo $path."ssss";die;
					...
					if($rs)
					{
						setRedirect("index.php?module=products&view=add_update_excel",$rs,'suc');
					}
					else 
					{
						setRedirect("index.php?module=products&view=add_update_excel",FSText::_('Không có bản ghi nào được cập nhật'),'alert');
					}	
				}
