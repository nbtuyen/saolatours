	...
	function upload_excel($input_name)
	{
		...
		if(	!$excel){
			...
			if($cid){
				...
				if($rs)
				{
					setRedirect("index.php?module=products&view=add&cid=$cid",FSText::_('Có').'<strong> '.$rs.'</strong> '.'bản ghi được thêm vào','suc');
				}
				else 
				{
					setRedirect("index.php?module=products&view=add&cid=$cid",FSText::_('Không có bản ghi nào được thêm vào'),'alert');
				}	
			}else{
                                        // echo $path."ssss";die;
				...
				if($rs)
				{
					setRedirect("index.php?module=products&view=add",FSText::_('Có').'<strong> '.$rs.'</strong> '.'bản ghi được thêm vào','suc');
				}
				else 
				{

					setRedirect("index.php?module=products&view=add",FSText::_('Không có bản ghi nào được thêm vào'),'alert');
				}	
			}
