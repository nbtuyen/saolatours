<form action="javascript:void(0);" method="post" name="rate_add_form" id='rate_add_form' class='form_rate hide_form cls' class="form_rate" onsubmit="javascript: submit_rate();return false;">
	...
	<div class="wraper_form_rate hide">
		<div class="_textarea">
			<textarea name="content" id="rate_content"   placeholder="Viết bình luận của bạn(Tối thiểu 65 ký tự)" onkeyup="countTxtRating()"></textarea>
		...
		<div class="wrap_rate cls"> 
			...
			<div class="wrap_loginpost">            
				...
				<div class="pull-right clearfix">
					<input type="submit" class="_btn_rate" value="Gửi bình luận">  
				</div> 
			</div>            
