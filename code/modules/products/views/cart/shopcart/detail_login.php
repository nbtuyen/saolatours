...
<div id="form-login" class="overflow-hidden shadow hidden">
	<div class="text-center">
		...
		<a class="login_fb btn btn-login fb current" title="Đăng nhập bằng Facebook" href="<?php echo  htmlspecialchars($loginUrl);?>">
		...
		<a class="login_gg btn btn-login go current" title="Đăng nhập bằng Google" href="javascript:void(0)" data-url="<?php echo $google_client-> createAuthUrl();?>" data-width="800" data-height="500" data-id="google-login" onclick="openPopupWindow(this);">
	...
	<form action="<?php echo FSRoute::_("index.php?module=users&task=login") ?>" method="post" name="login_form_cart" class="form-login" onsubmit="javascript: return checkFormsubmit_login_cart();">
		...
		<table cellpadding="5" cellspacing="0" width="100%">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="email" id="email_login_cart" value="<?php echo isset($_COOKIE['save_login_username']) ? $_COOKIE['save_login_username'] : '' ?>" class='form-control'  placeholder="<?php echo FSText::_('Email'); ?>" required />
					</td>
				</tr>
				<tr>
					<td>Mật khẩu</td>
					<td>
						...
						<input type="password" name="password" id="password_login_cart"  class='form-control' autocomplete="off"  placeholder="<?php echo FSText::_("Mật khẩu") ?>" required value="<?php echo isset($_COOKIE['save_login_password']) ? $_COOKIE['save_login_password'] : '' ?>" />
					</td>
				</tr>
				<tr>
					<td></td>
					<td>
						...
						<div class="reset-pass">Quên mật khẩu? Khôi phục mật khẩu <a href="<?php echo FSRoute::_("index.php?module=users&task=forget") ?>" class="green">tại đây</a></div>
						<input type="button" value="Đăng nhập" class="btn btn-primary d-block signin-submit-cart">
					</td>
				</tr>
			</tbody>
		</table>
