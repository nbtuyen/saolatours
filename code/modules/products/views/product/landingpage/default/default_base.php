...
<section class=" section section1 cls">
	<div class="container">
		<div class="left base_left">
			...
			<img alt="<?php echo $data -> name; ?>" src="<?php echo URL_ROOT.$data -> landingpage_image_left; ?>" /> 
		...
		<div class="right base_right">
			<img alt="<?php echo $data -> name; ?>" src="<?php echo URL_ROOT.$data -> landingpage_image_right; ?>" /> 
		</div>
	</div>
