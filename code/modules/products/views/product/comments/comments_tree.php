...
function display_comment_item($item,$childdren,$level,$max_level = 2,$return){
	...
	$html .= '	<input type="hidden" value="'.$item->product_id.'" name="record_id"  />';
...
<div class='comments'>
	...
	<form action="#" method="post" name="comment_add_form" id='comment_add_form' class='form_comment'>
		<p class='name_email'>
			<input type="text" id="name" value="Họ tên" name="name"   onfocus="if(this.value=='Họ tên') this.value=''" onblur="if(this.value=='') this.value='Họ tên'"/>
			<input type="text" id="email" value="Email" name="email"  onfocus="if(this.value=='Email') this.value=''" onblur="if(this.value=='') this.value='Email'" />
		</p>
		<div class="clear"></div>
		<textarea id="text" rows="5" name="text" onfocus="if(this.value=='Nội dung') this.value=''" onblur="if(this.value=='') this.value='Nội dung'">Nội dung</textarea>
		 <p class='captcha'>
