<?php 
	class ImagesModelsHome extends FSModels
	{
		...
		function set_query_body()
		{
			...
			$fs_table = FSFactory::getClass('fstable');
			 $query = " FROM ".$fs_table -> getTable('fs_images')."
						  WHERE 
						  	 published = 1
						  	". $where.
		...
		function getImagesList($query_body)
		{
			if(!$query_body)
				return;
				
			global $db;
			 $query = " SELECT id,name,summary,image, created_time,category_id, category_alias, alias,comments_total,comments_published";
