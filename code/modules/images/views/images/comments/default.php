...
<!--				<p class='email'><?php echo $item -> email?></p>-->
	...
	<form action="#" method="post"  name="comment_add_form" id='comment_add_form' class='form_comment'>
		<p class='name_email'>
			<input type="text" id="name" required value="Họ tên" name="name" size="40"  onfocus="if(this.value=='Họ tên') this.value=''" onblur="if(this.value=='') this.value='Họ tên'"/>
			<input type="email" id="email" required value="Email" name="email" size="40" onfocus="if(this.value=='Email') this.value=''" onblur="if(this.value=='') this.value='Email'" />
		</p>
		<p class='captcha'>
			<input required type="text" id="txtCaptcha" value="Mã kiểm tra" name="txtCaptcha"  maxlength="10" size="23" onfocus="if(this.value=='Mã kiểm tra') this.value=''" onblur="if(this.value=='') this.value='Mã kiểm tra'" />
		...
		<textarea required id="text" cols="84" rows="5" name="text" onfocus="if(this.value=='Nội dung') this.value=''" onblur="if(this.value=='') this.value='Nội dung'">Nội dung</textarea>
		...
		<!--	<a class="button" href="javascript: void(0)" id='submitbt'>
            ...
            <button rel="nofollow" class="button" id='submitbt'><span>Gửi</span></button>
           <script>
