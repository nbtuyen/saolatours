	...
	<div class="bot-content">
		...
		<div class="top_click_review click_review">
			<?php $j=1; foreach ($list_review as $review_item){ ?>
				<a href="<?php echo $link.'#'.$review_item->alias ?>" title=""><?php echo $j ?></a>
			<?php $j++; } ?>
		</div>
			...
			<?php $t=1; foreach ($list_review as $review_item) { ?>
				<div class="popup_rate_review popup_rate_review_<?php echo $review_item->id ?>">
					...
					<div class="popup_rate_review_star">
						...
						<div class="cls ratings_review">
							<i data-id="<?php echo $review_item->id ?>" class="icon_v1 rate_1 star_on" id="rate_1" ></i>
							<i data-id="<?php echo $review_item->id ?>" class="icon_v1 rate_2 star_on" id="rate_2" ></i>
							<i data-id="<?php echo $review_item->id ?>" class="icon_v1 rate_3 star_on" id="rate_3" ></i>
							<i data-id="<?php echo $review_item->id ?>" class="icon_v1 rate_4 star_on" id="rate_4" ></i>
							<i data-id="<?php echo $review_item->id ?>" class="icon_v1 rate_5 star_on" id="rate_5" ></i>
				...
				<div class="item cls">
			            	...
			            	<?php if(!empty($authors[$review_item-> author_id])){ ?>
								<div class="author-review">
									<a title="<?php echo $authors[$review_item-> author_id]->name ; ?>" class="author-name" href="<?php echo $authors[$review_item-> author_id]->link ; ?>">
										<amp-img alt="<?php echo htmlspecialchars($authors[$review_item-> author_id]->name);?>" src="<?php echo URL_ROOT . str_replace('/original/','/resized/',$authors[$review_item-> author_id]->image);?>"  width="40" height="40"/>
									</a>						
								</div>
							<?php } ?>
			            </div>
			        ...
			        <div class="media-body">
			        	...
			        	<div class="content_review description">
			        		<?php echo replce_content_amp($review_item->description) ?>
