			...
			<div class="header_l item">
				...
				<?php if($item->image){?>				
					<a class='item-img' href="<?php echo $link; ?>">
						<amp-img src="<?php echo URL_ROOT.str_replace('/original/','/large/', $item->image); ?>" alt="<?php echo htmlspecialchars(@$item->title); ?>" width="394" height="272" />
					</a>				
				<?php } ?>
				</figure>
				...
				<div class='inner-item'>
					...
					<?php if($item->image){?>				
						<a class='item-img' href="<?php echo $link; ?>">
							...
							<amp-img src="<?php echo URL_ROOT.str_replace('/original/','/resized/', $item->image); ?>" alt="<?php echo htmlspecialchars(@$item->title); ?>" width="192" height="128" />
						</a>				
					<?php } ?>
					</figure>
