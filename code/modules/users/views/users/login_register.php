...
if(isset($_COOKIE['user_id'])){
	setRedirect(FSRoute::_("index.php?module=users&task=user_info"));
}
	...
	<div class="row frame_body cls">
		<div class="col-signin col-lg-6">
			<div class="signin_inner">
				...
				<form action="<?php echo FSRoute::_("index.php?module=users&view=users") ?>" name="login_form_md" class="form"  method="post">
					<div class="fieldset_item_row" >
						<div class="form_name">
							Email:
						</div>
						<div class="value">
							<input class="txtinput" id="username_dk_dn" type="text" size="30" name="email"  value="" />
						</div>
					</div>
					<div class="fieldset_item_row" >
						<div class="form_name">
						...
						<div class="value">
							<input class="txtinput" id="password_dk_dn" type="password" size="30"  name="password" value="" >
						</div>
					</div>
					<div class="fieldset_item_row" >
						<div class="form_name">
					...
					<?php $return = FSRoute::_("index.php?module=users&task=user_info"); ?>
		...
		<input type="hidden" name = "redirect_login" value = "1" />
	</form> 
</div>
</div>
