...
$senderid = str_replace("'","",$data_noti -> sender_id);
?>
<?php $fsform = FSFactory::getClass('fsform','form'); ?>
<?php include 'menu_user.php'; ?>
<div class="user_content">
	
	<div class="head_content"><?php //echo $data_noti_item->title ?></div>
                                ...
                                <div class="form_body row-cl">
                                        ...
                                        <?php } ?>
                                                            ...
                                                            <div class="item-inbox row-cl">
                                                                   <div class='email-head'>
                                                                        <div class='email-head-left'>
                                                                            <p class='email-sender'> <?php echo FSText::_('Sender') ?>: 
                                                                                <?php
                                                                                    if(!@$arr_fullname[$senderid]){
                                                                                                echo ' <span>'.$data_noti -> sender_username.'</span>';                                                              
                                                                                            }else {
                                                                            ...
                                                                            <?php if($data_noti ->recipients_id){?>
                                                                                <p class='email-recipient'> <?php echo FSText::_('Recipient') ?>: 
                                                                                    <?php
                                                                                        $str_recipients = $data_noti ->recipients_id;
                                                                        ...
                                                                        <p class='email-head-right created_time'><?php echo show_datetime($data_noti -> created_time); ?></p>
                                                                        
                                                                    <div class='clear'> </div>
                                                                </div><!-- END: .email-head -->
                                                                <div class='email-body row-cl'>
                                                                    <?php echo $data_noti -> message; ?>
                                                                </div><!-- END: .email-body -->
                                                            </div><!-- END: .body-sender -->
                                                    ...
                                                    <div class="form_user_footer row-cl">
                                                        <?php if($data_noti -> sender_username != 'Admin'){?>
