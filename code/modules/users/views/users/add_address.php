	...
	<div class="tab_content_inner clearfix">
		<form id="form-add-address" action="<?php echo FSRoute::_("index.php?module=users&task=add_address_save&Itemid=40"); ?>" method="post" name="form-add-address">
			...
			<div class="fieldset_item_row cls">
				...
				<div class="value">
					<input class="txtinput" type="text" name="telephone" id="telephone" value="" placeholder="Nhập số điện thoại" />
				</div>
			</div>
			<div class="fieldset_item_row cls">
			...
			<div class="fieldset_item_row cls">
				<?php dt_edit_selectbox(FSText::_('Quận huyện'),'district_id',@$data -> district_id,0,$districts,$field_value = 'id', $field_label='name',$size = 1,0); ?>
			</div>
			<div class="fieldset_item_row cls">
				<?php dt_edit_selectbox(FSText::_('Xã phường'),'ward_id',@$data -> ward_id,0,$wards,$field_value = 'id', $field_label='name',$size = 1,0); ?>
			</div>
			...
			<div class="fieldset_item_row checkdefault cls">
				...
				<div class="value">
					<label class="label_default">
						<input class="txtinput" type="checkbox" name="is_default" id="is_default" value="1" />
