...
?>
<div class="frame_display  passive_cm">
	...
	<div class="frame_body">
		<div class="form_head">
			<p class='title'><span>Hoa h&#7891;ng th&#7909; &#273;&#7897;ng  </span></p>		
		</div>	
		<div class="form_body">
								...
								<div class="form_user_footer_body">	
										<table cellpadding="6" cellspacing="0">
											<tr >
												...
												<td class="td-left tbl_head">Doanh s&#7889; M-load </td>
											...
											<?php 
												...
												$hight_paid_level = @$cm_passive_detail -> hight_paid_level ? $cm_passive_detail -> hight_paid_level: 0;
											?>
											<?php for($i = 0 ; $i < 7; $i ++ ){?>
											<tr>
												...
												<td class="td-left">
													<?php                    
														$level_mload_field = "level".($i+1)."totalmload";
														$level_mload =  @$cm_passive_detail -> $level_mload_field? $cm_passive_detail -> $level_mload_field : 0;
														echo number_format($level_mload, 0, ',', '.');
													?>
												...
												<td class="td-left"> 
													<?php                       
														...
														$level_total_field = "level".($i+1)."totalsc";
														$level_total =  @$cm_passive_detail -> $level_total_field? $cm_passive_detail -> $level_total_field: 0;
...
function load_commission_month()
{
	...
	year_to = $("#year_to").val();
	$.ajax({
		  url: "index.php?module=users&view=commission&task=ajax_load_passive&raw=1&yt="+year_to+"&yf="+year_from+"&mt="+month_to+"&mf="+month_from+"",
		  cache: false,
