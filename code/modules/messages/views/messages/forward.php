								...
								<div class="form_user_body_inner">
									...
									<table width="100%" cellpadding="5" >
										...
										<tr>
											...
											<td>
												<input type="text" name='subject' id='subject' value='<?php echo "Fwd: ".$data->subject; ?>'/>
											</td>
										</tr>
										<tr>
											<td> <span class='red'>*</span>N&#7897;i dung</td>
											<td>
												<textarea rows="8" cols="30" name='message' id='message'><?php echo strip_tags($data -> message); ?></textarea>
											</td>
										</tr>
										<tr>
											<td ></td>
