...
<div class='news_comments'>
		...
		?>
			<div class="add-task">
					<h5 class='comment_form_title_send' ><img onerror="this.src='/images/no-img.png'" src="<?php echo URL_ROOT.'images/comment-icon.png';?>" alt="Ý kiến bạn đọc" title="Ý kiến bạn đọc" />Ý kiến bình luận</h5>
