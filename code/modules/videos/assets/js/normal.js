$('#one_video_play_area .video_item_inner_has_img').click(function(){
	...
	$(this).html('<iframe src="'+link_video+'?rel=0&autoplay=1" width="100%" height="299" frameborder="0" allowfullscreen="false">');
...
function reload_video(link_video){
	var video = '<iframe src="'+ link_video +'"></iframe>';
	$('#one_video_play_area .video_item_inner').html('<iframe src="'+link_video+'?rel=0&autoplay=1" width="100%" height="299" frameborder="0" allowfullscreen="false">');
