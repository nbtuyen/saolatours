...
<!--				<p class='email'><?php echo $item -> email?></p>-->
	...
	<!-- FORM COMMENT	-->
	<h5 class='comment_form_title' ><img src="<?php echo URL_ROOT.'modules/advices/assets/images/1375436981_comment.png';?>" alt="tag-icon" title="tag-icon" />Gửi bình luận</h5>
	<form action="#" method="post" name="advice_comment_add_form" id='advice_comment_add_form' >
		<p class='name_email'>
