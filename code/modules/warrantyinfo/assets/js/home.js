 function load_form(){
    let phone = $("#phone_number").val();
      $.ajax({
    type: "POST",
    url: "/index.php?module=warrantyinfo&view=home&task=fetch_warranty&raw=1",
    data: {phone:phone,imei:phone},
    cache: false,
 ...
 function load_form2(){
    let phone = $("#phone_number2").val();
      $.ajax({
    type: "POST",
    url: "/index.php?module=warrantyinfo&view=home&task=fetch_warranty2&raw=1",
    data: {phone:phone,imei:phone},
    cache: false,
    success: function(html){
      $("#box_search2").html(html);
    }
  });
}
...
function check_Formsubmit()
{
  ...
  if(!notEmpty("imei_buy_fast","Bạn phải nhập mã máy"))
  {
    return false;
  }
